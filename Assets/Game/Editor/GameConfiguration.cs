...
public partial class GameConfiguration : GameSettings {
    ...
    public static readonly List<GameConfiguration> GameConfigurationList = new List<GameConfiguration>() {
        new GameConfiguration() {
            gameConfigurationName        = "DEFAULT",
            gameConfigurationDescription = "開発用デフォルト設定",
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "デバッグ用クライアント",
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "デバッグ用サーバ",
        ...
        new GameConfiguration() {
            gameConfigurationName        = "RELEASE_CLIENT",
            gameConfigurationDescription = "リリース用クライアント",
            runtimeServiceMode           = GameSettings.ServiceMode.Client,
            serverAddress                = null,
            serverPort                   = 0,
            serverPortRandomRange        = 0,
        ...
        new GameConfiguration() {
            gameConfigurationName        = "RELEASE_SERVER",
            gameConfigurationDescription = "リリース用サーバ",
            runtimeServiceMode           = GameSettings.ServiceMode.Client,
            serverAddress                = "0.0.0.0",
            serverPort                   = 8000,
