...
public partial class GameConfiguration : GameSettings {
    ...
    public static readonly List<GameConfiguration> GameConfigurationList = new List<GameConfiguration>() {
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "デバッグクライアント (実行可能形式, UDP)",
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "デバッグサーバ (実行可能形式, UDP)",
        ...
        new GameConfiguration() {
            gameConfigurationName        = "SERVICES_DEBUG_SERVER",
            gameConfigurationDescription = "サービス用デバッグサーバ (Linux Headless, Non Host Mode, UDP)",
            runtimeServiceMode           = GameSettings.ServiceMode.Server,
            serverAddress                = "localhost",
            serverPort                   = 7778,
            serverPortRandomRange        = 0,
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "ローカルクライアント (WebGL, TCP WebSocket)",
            runtimeServiceMode           = GameSettings.ServiceMode.Client,
            serverAddress                = null,
            serverPort                   = 0,
            serverPortRandomRange        = 0,
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "サービス用ローカルクライアント (WebGL, TCP WebSocket)",
            runtimeServiceMode           = GameSettings.ServiceMode.Client,
            serverAddress                = null,
            serverPort                   = 0,
            serverPortRandomRange        = 0,
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "サービス用ローカルサーバ (Linux Headless, Non Host Mode, TCP WebSocket)",
            runtimeServiceMode           = GameSettings.ServiceMode.Server,
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "サービス用 fu-n.net クライアント (WebGL, TCP WebSocket)",
            runtimeServiceMode           = GameSettings.ServiceMode.Client,
            serverAddress                = null,
            serverPort                   = 0,
            serverPortRandomRange        = 0,
        ...
        new GameConfiguration() {
            ...
            gameConfigurationDescription = "サービス用 fu-n.net サーバ (Linux Headless, Host Mode, TCP WebSocket)",
            runtimeServiceMode           = GameSettings.ServiceMode.Server,
            serverAddress                = "0.0.0.0",
            serverPort                   = 8000,
            serverPortRandomRange        = 1999,
            serverDiscoveryAddress       = "localhost",
