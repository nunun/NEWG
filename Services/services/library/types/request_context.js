...
// cancel request
RequestContext.prototype.cancelRequest = function(requestId, error) {
    this.logger.debug("cancelRequest: requestId[" + requestId + "] error[" + error + "]");
    this.setResponse(requestId, new Error(error || 'cancelled.'), null);
}
